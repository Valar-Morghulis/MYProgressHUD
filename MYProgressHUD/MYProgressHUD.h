...
typedef enum {
    ...
    MYProgressHUDModeIndeterminate,
    /** Progress is shown using a MBRoundProgressView. */
	MYProgressHUDModeDeterminate,
	/** Shows a custom view */
	MYProgressHUDModeCustomView
} MYProgressHUDMode;

typedef enum {
    /** Opacity animation */
    MYProgressHUDAnimationFade,
    /** Opacity + scale animation */
    MYProgressHUDAnimationZoom
} MYProgressHUDAnimation;
 ...
 * The MYProgressHUD window spans over the entire space given to it by the initWithFrame constructor and catches all
 ...
 * - MYProgressHUDModeIndeterminate - shows a UIActivityIndicatorView
 * - MYProgressHUDModeDeterminate - shows a custom round progress indicator (MBRoundProgressView)
 * - MYProgressHUDModeCustomView - shows an arbitrary, user specified view (@see customView)
 *
...
@interface MYProgressHUD : UIView {
	...
	MYProgressHUDMode mode;
    MYProgressHUDAnimation animationType;
	...
	id<MYProgressHUDDelegate> __weak delegate;
#elif __has_feature(objc_arc)
	id<MYProgressHUDDelegate> __unsafe_unretained delegate;
#else
	id<MYProgressHUDDelegate> delegate;
#endif
    NSString *labelText;
 ...
 */
+ (MYProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated;
...
/**
 * The UIView (i.g., a UIIMageView) to be shown when the HUD is in MYProgressHUDModeCustomView.
...
/** 
 * MYProgressHUD operation mode. Switches between indeterminate (MYProgressHUDModeIndeterminate) and determinate
 * progress (MYProgressHUDModeDeterminate). The default is MYProgressHUDModeIndeterminate.
 *
 * @see MYProgressHUDMode
 */
@property (assign) MYProgressHUDMode mode;

/**
 * The animation type that should be used when the HUD is shown and hidden. 
 *
 * @see MYProgressHUDAnimation
 */
@property (assign) MYProgressHUDAnimation animationType;

/** 
 * The HUD delegate object. If set the delegate will receive hudWasHidden callbacks when the HUD was hidden. The
 * delegate should conform to the MYProgressHUDDelegate protocol and implement the hudWasHidden method. The delegate
...
@protocol MYProgressHUDDelegate <NSObject>
 ...
 */
- (void)hudWasHidden:(MYProgressHUD *)hud;
